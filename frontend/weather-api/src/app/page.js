    ...
    <Head>
      ...
      <h2 className="flex justify-center mt-4 text-white text-2xl">
        <form onSubmit={connect}>
          <input 
            ...
            className="ml-3 px-1 w-64 lg:w-96 bg-black/10 border-slate-800/10 border-2 backdrop-blur-[400px] hover:bg-black/30"
      ...
      </h2>
      {
        ...
        <div className="flex flex-row flex-direction justify-around h-full w-full">
          <div className="flex flex-col justify-center items-center w-1/2 xl:w-2/5">
              <ul 
                className="flex flex-col lg:w-4/5 text-white backdrop-blur-[20px] p-3 lg:p-6 my-10 rounded-md bg-slate-950/5 hover:bg-slate-100/5" 
                key={todayData.datetime}
              >
                <li className="mb-6 text-5xl xl:text-7xl">Today</li>
                <li className="mb-6 text-7xl xl:text-9xl">{todayData.temp} °F</li>
                <li className="text-3xl">Feels like {todayData.feelslike} °F</li>
                <div className="flex flex-row items-center">
                  <li className="text-3xl xl:text-5xl">{todayData.conditions}</li>
                  <Image 
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1">
            {
              fiveDayData?.map((weather) => {
                return(
                  <ul 
                    className="flex items-start justify-center flex-col m-4 lg:m-10 px-12 py-2 rounded-lg text-xl lg:text-4xl text-white backdrop-blur-[400px] hover:bg-slate-100/5" 
                    key={weather.datetime}
                  >
                    <li className="mb-6">{getDay(weather.datetime)}</li>
                    <li className="mb-6 text-5xl lg:text-6xl">{weather.temp} °F</li>
